...
/**
 * TODO: считать клики по ссылкам контактов:
 * при первых кликах открывать ссылки в новой вкладке,
 * при клике на последнюю ссылку направлять пользователя оставаясь на текущей вкладке.
 */
